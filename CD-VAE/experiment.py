...
def run(args, kwargs):
    ...
    model_name = args.dataset_name + '_' + '_' + \
    ...
    # loading data
    train_loader, background_loader, val_loader, test_loader, args = load_dataset(args, **kwargs)
    ...
    experiment_vae(args, train_loader, background_loader, val_loader, test_loader, model, optimizer, dir, log_dir, model_name = 'Hvamp')
    # ======================================================================================================================
