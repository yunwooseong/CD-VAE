...
# ======================================================================================================================
def experiment_vae(args, train_loader, bgloader, val_loader, test_loader, model, optimizer, dir, log_dir, model_name='vae'):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        model, train_loss_epoch, train_re_epoch, train_kl_epoch = train(epoch, args, train_loader, bgloader, model, optimizer)

        val_loss_epoch, val_re_epoch, val_kl_epoch, val_ndcg_epoch = evaluate(args, model, train_loader, bgloader, val_loader, epoch, dir, mode='validation')
        time_end = time.time()
    ...
    eval_recall10, eval_recall5, eval_recall1 = evaluate(args, best_model, train_loader, bgloader, test_loader, 9999, dir, mode='test')
